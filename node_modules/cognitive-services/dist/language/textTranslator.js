...
var textTranslator = function (_commonService) {
     ...
     * @returns {Promise.<object>}
     */
    textTranslator.prototype.addTranslation = function addTranslation(_ref8) {
     ...
     * @returns {Promise.<object>}
     */
    textTranslator.prototype.addTranslationArray = function addTranslationArray(_ref9) {
        var body = _ref9.body;
        ...
        // Note: API expect XML elements to be sorted alphabetically
        var AddtranslationsRequest = xmlBuilder.create("AddtranslationsRequest");
        AddtranslationsRequest.ele("AppId");
        if (body["from"]) {
            AddtranslationsRequest.ele("From", null, body["from"]);
        }
        var namespace = "http://schemas.datacontract.org/2004/07/Microsoft.MT.Web.Service.V2";
        var options = AddtranslationsRequest.ele("Options");
        ...
        if (body["translations"]) {
            var translations = AddtranslationsRequest.ele("Translations");
            for (var i in body["translations"]) {
                var t = body["translations"][i];
                var translation = translations.ele("Translation", { xmlns: namespace });
     ...
     * @returns {Promise.<object>}
     */
    textTranslator.prototype.breakSentences = function breakSentences(_ref10) {
     ...
     * @returns {Promise.<object>}
     */
    textTranslator.prototype.getTranslations = function getTranslations(_ref11) {
     ...
     * @returns {Promise.<object>}
     */
    textTranslator.prototype.getTranslationsArray = function getTranslationsArray(_ref12) {
